...
### PRIORITY for next run (set Run #38 — FACTORY HELD; DO NOT IDEATE UNTIL SHIVAM STEERS):
- STATE: ideation is PAUSED (21 runs now: #18 asked + pushed, #19 re-surfaced + pushed, #20–#38
  re-surfaced QUIETLY — push throttled). All twenty-one honored the fired auto-skip trigger and
  emitted the steer-request prompt instead of generating. Shivam has NOT replied across #13–#38.
- RUN #39 REQUIRED ACTION: do NOT auto-generate. Check Shivam's notes / session for a steer
  ...
  • CADENCE (now in steady-state hold): re-surface in the report every held run, but do
    ...
    #20–#38 all went quiet under this rule. Avoid identical daily reminder pushes — they become noise.
